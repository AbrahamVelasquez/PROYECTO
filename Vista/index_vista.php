                            ...
                            <?php if (!empty($misConvenios)): ?>
                                ...
                                <tr class="hover:bg-orange-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-5 text-center">
                                        ...
                                        ?>
                                        <form action="<?= $urlDestino ?>" method="POST" onsubmit="return confirm('¿Quitar de la lista?');">
                                            <input type="hidden" name="id_convenio_eliminar" value="<?= $mc['id_convenio'] ?>">
                                            <button type="submit" name="btnEliminarFav" class="group flex items-center gap-2 mx-auto bg-red-50 hover:bg-red-500 text-red-500 hover:text-white px-4 py-2 rounded-lg transition-all border border-red-100 shadow-sm">
