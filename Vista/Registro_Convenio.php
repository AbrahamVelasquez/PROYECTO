...
<body class="min-h-svh bg-slate-50 text-slate-900 antialiased font-sans">
  <main class="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
    ...
    <header class="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm mb-8 flex justify-between items-center">
      ...
      <a href="/PROYECTO/index.php" class="bg-slate-100 hover:bg-slate-200 text-slate-600 px-6 py-3 rounded-xl text-[10px] font-black uppercase transition-all">← Cancelar</a>
    </header>

    <div class="rounded-3xl border border-slate-200 bg-white shadow-xl overflow-hidden">
      <form action="/PROYECTO/index.php" method="POST" class="p-10 space-y-8">
        
        <input type="hidden" name="accion" value="guardarNuevoConvenio">
        <input type="hidden" name="id_tutor_registro" value="<?= $_SESSION['id_tutor'] ?? '' ?>">
        <input type="hidden" name="nombre_tutor_registro" value="<?= $_SESSION['usuario'] ?? '' ?>">
        ...
        <section class="space-y-6">
          <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="md:col-span-4">
              ...
              <input type="text" name="direccion" required class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-bold uppercase outline-none">
            </div>
            <div class="md:col-span-2">
              <label class="block text-[10px] font-black uppercase text-slate-400 mb-2">Municipio</label>
              <input type="text" name="municipio" required class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-bold uppercase outline-none">
            </div>
            <div class="md:col-span-1">
              <label class="block text-[10px] font-black uppercase text-slate-400 mb-2">CP</label>
              <input type="text" name="cp" required class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-bold uppercase outline-none">
            </div>
            <div class="md:col-span-1">
              <label class="block text-[10px] font-black uppercase text-slate-400 mb-2">País</label>
              <input type="text" name="pais" value="ESPAÑA" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-bold uppercase outline-none">
            </div>
            <div class="md:col-span-1">
              <label class="block text-[10px] font-black uppercase text-slate-400 mb-2">Tfno</label>
              <input type="text" name="telefono" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-bold uppercase outline-none">
            </div>
            <div class="md:col-span-1">
              <label class="block text-[10px] font-black uppercase text-slate-400 mb-2">FAX</label>
              <input type="text" name="fax" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-bold uppercase outline-none">
            </div>
            <div class="md:col-span-2">
              <label class="block text-[10px] font-black uppercase text-slate-400 mb-2">Mail</label>
              <input type="email" name="email" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-bold outline-none">
            </div>
          </div>
        </section>
        ...
        <section class="pt-6 border-t border-slate-100 space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="md:col-span-1">
              ...
              <input type="text" name="nombre_rep_legal" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-bold uppercase outline-none">
            </div>
            <div class="md:col-span-1">
              <label class="block text-[10px] font-black uppercase text-slate-400 mb-2">DNI</label>
              <input type="text" name="dni_rep_legal" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-bold uppercase outline-none">
            </div>
            <div class="md:col-span-1">
              <label class="block text-[10px] font-black uppercase text-slate-400 mb-2">Cargo</label>
              <input type="text" name="cargo_rep_legal" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-bold uppercase outline-none">
            </div>
          </div>
        </section>
