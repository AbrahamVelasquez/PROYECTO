...
<div class="flex flex-wrap gap-3 mb-4 items-center">
    ...
    <button type="button" onclick="abrirModalPag('seg')" title="Configurar filas por página"
        class="flex items-center gap-1 px-2.5 py-2.5 rounded-xl border border-slate-200 text-[9px] font-black text-slate-400 hover:border-orange-300 hover:text-orange-600 hover:bg-orange-50 transition-all cursor-pointer uppercase tracking-wide whitespace-nowrap">
