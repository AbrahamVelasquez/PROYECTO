                ...
                <?php if (!empty($conveniosProceso)): ?>
                    <?php foreach ($conveniosProceso as $convP): ?>
                        <tr class="hover:bg-amber-50/50 transition-colors">
                            <td class="px-6 py-5 text-center">
                                <button type="button" class="text-amber-500 hover:text-amber-700 transition-colors p-2.5 rounded-xl hover:bg-amber-100/50 inline-flex items-center justify-center border border-transparent hover:border-amber-200">
