...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-04-2026 a las 02:50:52
...
(44, 1, 'ABRAHAM', 'Velasquez', 'Granados', 'ASFSFSDFS', 'H', 'abraham@gmail.com', ''),
(51, 1, 'Abraham', 'Martín', 'Granados', '23456789J', 'H', 'marcosf@gmail.com', ''),
(52, 1, 'Abraham', 'Velasquez', 'Torres', '67843123F', 'H', 'abraham@gmail.com', ''),
(53, 1, 'ABRAHAM', 'Pérez', 'Granados', '12222278A', 'H', 'marcopsf@gmail.com', ''),
(54, 1, 'marta', 'García', 'Sáncheza', 'ASFSFSDF1', 'M', 'pablofe@gmail.com', '');
...
(13, 8, 2, '2026-03-01', '2026-06-15', '08:00-15:00', 370, 'L-V', 7.00, 0),
(14, 9, 2, '2026-03-01', '2026-06-15', '', 0, 'L-V', 0.00, 0),
(15, 10, 4, '0000-00-00', '0000-00-00', '08:30-14:30', 370, 'L-V', 6.00, 0),
(16, 11, 4, '0000-00-00', '0000-00-00', '', 0, '', 0.00, 0),
(17, 12, 5, '2026-03-01', '2026-06-15', '09:00-17:00', 400, 'L-J', 8.00, 0),
(18, 52, 2, NULL, NULL, NULL, NULL, NULL, NULL, 0);
...
--
ALTER TABLE `alumnos`
  MODIFY `id_alumno` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT de la tabla `asignaciones`
--
ALTER TABLE `asignaciones`
  MODIFY `id_asignacion` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT de la tabla `asignaciones_firmadas`
--
ALTER TABLE `asignaciones_firmadas`
  MODIFY `id_firmada` int(6) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `convenios_nuevos`
  MODIFY `id_convenio_nuevo` int(6) UNSIGNED NOT NULL AUTO_INCREMENT;
