...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-05-2026 a las 02:48:08
...
(1, 1, '7', '2026-03-01', '2026-06-15', '08:00-15:00', 370, 'L-V', 7.00, 0, 'Kevin Gonzalez', NULL, NULL, NULL),
...
(13, 8, '5', '2026-03-01', '2026-06-15', '08:00-15:00', 370, 'L-V', 7.00, 0, 'Javier De la Cruz', NULL, NULL, NULL),
(14, 9, '5', '2026-03-01', '2026-06-15', NULL, 380, 'L-V', 0.00, 0, NULL, NULL, NULL, NULL),
(15, 10, '4', '2026-04-25', '2026-04-30', '09:30-16:00', 350, 'L-V', 7.00, 1, 'Fernando Martins', 'fer@gmail.es', '1234321999', NULL),
(17, 12, '19', '2026-03-01', '2026-06-15', '09:00-17:00', 400, 'L-J', 8.00, 1, 'Fernando Ríos', 'fer@gmail.com', '1234321567', NULL),
(27, 59, '22', '2026-04-25', '2026-04-30', '09:00-17:00', 380, NULL, 8.00, 1, 'Javier Andre', 'javier@gmail.com', '12312312', NULL),
(28, 13, '1', NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL),
...
INSERT INTO `convenios_nuevos` (`id_convenio_nuevo`, `especialidad`, `nombre_empresa`, `cif`, `direccion`, `localidad`, `cp`, `telefono`, `fax`, `representante`, `fecha_nueva_renovacion`) VALUES
(4, 1, 'ZAPIM', 'FIC', 'DIRECCION', 'MUNICIPIO', 'CP', 'TELEFONO', 'FAX', 'nombre', NULL),
(10, 1, 'Logic Gate S.L.', 'B88888888', 'Calle Transistor 8', 'Madrid', '28015', '910000071', '910000072', 'Vicente Figueroa', NULL),
(11, 1, 'Byte Masters', 'A99999999', 'Paseo del Código 9', 'Getafe', '28902', '910000081', '910000082', 'Lola Trujillo', NULL),
(12, 1, 'CLOUD SECURE S.A', 'B10101010', 'AVENIDA DEL LINK 10', 'LEGANéS', '28912', '910000091', '910000092', 'JAVIER MAROTO', NULL),
(13, 1, 'Dev Ops', 'B11101110', 'Calle Script 11', 'Móstoles', '28932', '910000101', '910000102', 'Maite Figueroa', NULL),
(17, 1, 'Consultoría Energética', 'B77889900', 'Calle Recogidas 14', 'Granada', '18002', '958998877', '', 'Isabel Ramos Luna', NULL),
(18, 1, 'SISTEMAS DE DATOS CANTáBRICO', 'A44332211', 'CALLE REAL 88', 'SANTANDER', '39001', '942556677', '942556678', 'FERNANDO RUIZ DEHESA', NULL),
(23, 1, 'FARMATODO S.A', '123123', 'TRES CA 16', 'MARACAY', '22119', '611000000', 'FAX', 'Farmacias SA', NULL),
(25, 1, 'PASCUAL VARIANTES', '234234', 'AV. DE LOS LABRADORES', 'TRES CANTOS', '28760', '92818910', '382823', 'ANA PASCUAL', NULL),
(28, 1, 'FARMACIA LITERATOS S.A', '3234', 'AV. DE LOS LABRADORES', 'TRES CANTOS', '28760', '2409239', '21312', 'ANGELA', NULL),
(31, 1, 'FARMATODO S.A', '123123', 'TRES CA 16', 'MARACAY', '22119', '611000000', 'FAX', 'Farmacias SA', NULL),
(39, 1, 'COGNODATA', 'CIF', 'DIRECCION', 'cojedes', 'CP', '726182743', 'FAX', 'NOMBRE', NULL);
...
--
ALTER TABLE `alumnos`
  MODIFY `id_alumno` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
...
--
ALTER TABLE `asignaciones_firmadas`
  MODIFY `id_firmada` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `convenios_aprobados`
  MODIFY `id_convenio_aprobado` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT de la tabla `convenios_nuevos`
--
ALTER TABLE `convenios_nuevos`
  MODIFY `id_convenio_nuevo` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `curso_academico`
  MODIFY `id_curso_academico` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `resultados_aprendizaje`
  MODIFY `id_ra` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `tutores`
--
ALTER TABLE `tutores`
  MODIFY `id_tutor` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `usuarios`
--
ALTER TABLE `usuarios`
  MODIFY `id_usuario` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
