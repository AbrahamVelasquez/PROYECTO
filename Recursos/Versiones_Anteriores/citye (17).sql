...
-- Tiempo de generación: 30-04-2026 a las 02:35:09
...
(1, 1, 7, '2026-03-01', '2026-06-15', '08:00-15:00', 370, 'L-V', 7.00, 0, 'Kevin Gonzalez', NULL, NULL),
...
(4, 4, 4, '2026-05-10', '2026-06-10', '08:00-15:00', 370, 'L-V', 7.00, 1, NULL, NULL, NULL),
...
(13, 8, 5, '2026-03-01', '2026-06-15', '08:00-15:00', 370, 'L-V', 7.00, 0, 'Javier De la Cruz', NULL, NULL),
(14, 9, 5, '2026-03-01', '2026-06-15', NULL, 380, 'L-V', 0.00, 0, NULL, NULL, NULL),
(15, 10, 4, '2026-04-25', '2026-04-30', '09:30-16:00', 350, 'L-V', 7.00, 1, 'Fernando Martins', 'fer@gmail.es', '1234321999'),
(17, 12, 19, '2026-03-01', '2026-06-15', '09:00-17:00', 400, 'L-J', 8.00, 1, 'Fernando Ríos', 'fer@gmail.com', '1234321567'),
(27, 59, 22, '2026-04-25', '2026-04-30', '09:00-17:00', 380, NULL, 8.00, 1, 'Javier Andre', 'javier@gmail.com', '12312312'),
(28, 13, 1, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL),
(29, 58, 1, '2026-04-18', '2026-04-30', '08:00-16:00', 380, NULL, 7.00, 1, 'Leornardo Fernandez', 'leornardo.guti@techcloud.com', '1231231231');
...
(29, 'Indra Sistemas S.A.', 'A-28123456', 'Calle del Futuro, 12', 'Alcobendas', '28108', 'España', '916 000 111', '917 330 122', 'rrhh@indra.es', 'Alicia Gómez Valles', '44556677r', 'Directora de Operaciones'),
(1123, 'Cabify España', 'B-86987654', 'Avenida de la Movilidad, 45', 'Madrid', '28001', 'España', '912 333 444', '916 919 040', 'contacto@cabify.com', 'Roberto Jiménez Sanz', '01223344M', 'Jefe de Sistemas'),
(1124, 'Jobandtalent', 'B-85112233', 'Paseo de la Castellana, 200', 'Madrid', '28046', 'España', '915 888 999', '914 120 443', 'legal.consulting@jobandtalent.es', 'María Torres Pardo', '77889900K', 'Apoderada Legal');
...
(20, 31, '2026-04-27 08:48:13', 1),
(21, 39, '2026-04-29 07:01:32', 1);
...
(23, 1, 'FARMATODO S.A', '123123', 'TRES CA 16', 'MARACAY', '22119', 'ESPAÑA', '611000000', 'FAX', 'asdasdsdad@gmail.com', 'Farmacias SA', 'DNI', 'ASD'),
...
(31, 1, 'FARMATODO S.A', '123123', 'TRES CA 16', 'MARACAY', '22119', 'ESPAÑA', '611000000', 'FAX', 'asdasdsdad@gmail.com', 'Farmacias SA', 'DNI', 'ASD'),
(39, 1, 'COGNODATA', 'CIF', 'DIRECCION', 'cojedes', 'CP', 'ESPAÑA', '726182743', 'FAX', 'MAIL@cognodata.com', 'NOMBRE', 'DNI', 'CARGO');
...
--
ALTER TABLE `asignaciones`
  MODIFY `id_asignacion` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `convenios`
  MODIFY `id_convenio` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1125;
