...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-04-2026 a las 23:52:46
...
(1, 1, 7, '2026-03-01', '2026-06-15', '08:00-15:00', 370, 'L-V', 7.00, 1, NULL, NULL, NULL),
(2, 2, 2, '2026-03-01', '2026-06-15', '09:00-14:00', 370, 'L-V', 5.00, 0, NULL, NULL, NULL),
...
(13, 8, 2, '2026-03-01', '2026-06-15', '08:00-15:00', 370, 'L-V', 7.00, 1, 'Javier Antonio', 'javier@gmail.com', '123456789'),
(14, 9, 2, '2026-03-01', '2026-06-15', '', 0, 'L-V', 0.00, 0, NULL, NULL, NULL),
(15, 10, 4, '0000-00-00', '0000-00-00', '', 370, 'L-V', 6.00, 0, NULL, NULL, NULL),
(17, 12, 1, '2026-03-01', '2026-06-15', '09:00-17:00', 400, 'L-J', 8.00, 1, NULL, NULL, NULL),
(27, 59, 2, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL),
...
INSERT INTO `ciclos` (`id_ciclo`, `id_curso`, `nombre_ciclo`, `grado`) VALUES
(1, 2, 'DAW', 'Superior'),
(2, 2, 'SMR', 'Media'),
(3, 1, 'DAM', 'Superior'),
(4, 2, 'ASIR', 'Superior'),
...
(26, 'gggggggggggggg', 'QQQQQQQQ', 'EEEEEEEEEEE', 'DDDDDDDDDD', 'rrrrrrrrrr', 'ESPAÑA', 'vvvvvv', 'xxxxxxxxxx', 'bbbbbbbbb@bb.com', 'TTTTTTTT', 'TTYYY', 'UUUUUUUU');
...
INSERT INTO `modulos` (`id_modulo`, `nombre`, `id_ciclo`) VALUES
(2, 'Desarrollo Web en Entorno Servidor', 1),
(612, 'Desarrollo Web en Entorno Cliente', 1),
(615, 'Diseño de Interfaces Web', 1);
...
INSERT INTO `resultados_aprendizaje` (`id_ra`, `id_alumno`, `id_modulo`, `numero_ra`, `impartido_empresa`, `periodo`) VALUES
(1, 8, 2, 7, 0, '2'),
(2, 8, 2, 9, 0, '2');
...
ALTER TABLE `modulos`
  ...
  ADD KEY `fk_modulo_ciclo` (`id_ciclo`);
...
ALTER TABLE `resultados_aprendizaje`
  ...
  ADD KEY `fk_ra_alumno` (`id_alumno`),
...
--
ALTER TABLE `asignaciones_firmadas`
  MODIFY `id_firmada` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `convenios_nuevos`
  MODIFY `id_convenio_nuevo` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `modulos`
  MODIFY `id_modulo` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=616;

--
-- AUTO_INCREMENT de la tabla `resultados_aprendizaje`
--
ALTER TABLE `resultados_aprendizaje`
  MODIFY `id_ra` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `modulos`
  ADD CONSTRAINT `fk_modulo_ciclo` FOREIGN KEY (`id_ciclo`) REFERENCES `ciclos` (`id_ciclo`) ON DELETE CASCADE;

--
-- Filtros para la tabla `resultados_aprendizaje`
--
ALTER TABLE `resultados_aprendizaje`
  ADD CONSTRAINT `fk_ra_alumno` FOREIGN KEY (`id_alumno`) REFERENCES `alumnos` (`id_alumno`) ON DELETE CASCADE,
