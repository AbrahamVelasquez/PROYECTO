...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-04-2026 a las 17:26:23
...
(8, 'Alejandro', 'García', 'Pérez', '12345678A', 'H', '', ''),
...
(13, 8, 5, '2026-03-01', '2026-06-15', '08:00-15:00', 370, 'L-V', 7.00, 0, NULL, NULL, NULL),
...
(27, 59, 22, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL),
...
(37, 1, 'COGNODATA', 'SAS', 'SAS', 'SAS', 'sasas', 'ESPAÑA', 'asas', 'asa', 'sasasas@asdas.com', 'ASA', 'SAS', 'ASAS');
...
--
ALTER TABLE `asignaciones_firmadas`
  MODIFY `id_firmada` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
